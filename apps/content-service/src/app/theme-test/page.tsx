export default function ThemeTestPage() {
  return (
    <div className="main-content">
      <h1 className="page-title">Content Service Theme Test</h1>
      ...
      <div className="dashboard-grid">
        <div className="dashboard-card">
          ...
          <p className="card-description">
            This card shows the purple theme in action. Notice the colors automatically
        ...
        <div className="dashboard-card service-indicator">
          ...
          <p className="card-description">
            ...
            based on the .content-theme class.
          </p>
          <button className="card-button">
            Test Variables
          </button>
